...
global_keys.globalkeys = gears.table.join(
	...
	awful.key({ "Shift" }, "Print" ,function() awful.spawn("flameshot gui") end,
		{ description = "take the screen shot using flameshot", group = 'launcher'}),
	-- Brightness Manager
	awful.key({    }, "XF86MonBrightnessUp", function () awful.spawn("brightnessctl set 10%+") end,
		{ description = "Increase the brightness of the screen", group = 'launcher'}),
	awful.key({    }, "XF86MonBrightnessDown", function () awful.spawn("brightnessctl set 10%-") end,
		{ description = "Increase the brightness of the screen", group = 'launcher'}),
	-- Audio Manager
	awful.key({    }, "XF86AudioMute", function () awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ 0%") end, 
	...
	awful.key({    }, "XF86AudioLowerVolume", function () awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ -5%") end, 
    	...
    	-- Start file manager
	awful.key({ modkey }, "d", function () awful.spawn(terminal .. " -e yazi") end,
    		{description = "open yazi file manager", group = "launcher"}),
